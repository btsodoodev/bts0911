...
class _TimesheetsState extends State<Timesheets> with TickerProviderStateMixin {
  ...
  void didChangeDependencies() {
    ...
    if(_user.leadedUsersIds == null ) {
        setState(() {
          is3=true;
        });
    }
    if(_user.leadedUsersIds != null ) {
      if (_user.leadedUsersIds.isEmpty){
        setState(() {
          is3=true;
        });
      }
    ...
    _tabController = TabController(length:is3?3:4, vsync: this,initialIndex: widget.ini?? 0, );// initialise it here
