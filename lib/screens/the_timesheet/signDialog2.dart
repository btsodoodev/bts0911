...
class SignDialog2 extends StatefulWidget {
  ...
  final int dStatus;
  final String desc;
  SignDialog2(this.updateSign, this.row_date, [this.dStatus, this.dWilaya, this.desc]);
  @override
...
class _SignDialog2State extends State<SignDialog2> {
  ...
  @override
  void initState()  {
    _status = widget.dStatus;
    _wilaya = widget.dWilaya;
    super.initState();
  }
    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        child: new Column(
          ...
          children: [
            WilayaDD(_updateWilaya, widget.dWilaya),
            SizedBox(height: 20,),
            StatusDD(_updateStatus, widget.dStatus),
            SizedBox(height: 20,),
            TextField(
              onChanged: (text) {
                  _desc= text;
